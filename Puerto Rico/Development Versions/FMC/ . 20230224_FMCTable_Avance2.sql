...
select fmc_b_fla_fmc,fmc_e_fla_fmc,count(distinct fmc_s_att_account) as cuentas, sum(fmc_b_mes_numRGUS) as bom_tot_rgus, sum(fmc_e_mes_numRGUS) as eom_tot_rgus
from FMC_base 
group by 1,2
order by 1,2
