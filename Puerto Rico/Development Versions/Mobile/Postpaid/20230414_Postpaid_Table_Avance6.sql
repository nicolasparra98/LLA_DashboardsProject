...
SELECT  mob_s_dim_month
        ...
        ,mob_b_att_MaxStart
        ,mob_b_fla_Tenure
        ,IF(CAST(mob_b_mes_MRC AS VARCHAR) = 'NaN' OR mob_b_mes_MRC IS NULL,0,mob_b_mes_MRC) AS mob_b_mes_MRC
        ,mob_b_mes_numRGUS
        ,mob_e_dim_date
        ,mob_e_mes_TenureDays
        ,mob_e_att_MaxStart
        ,mob_e_fla_Tenure
        ,IF(CAST(mob_e_mes_MRC AS VARCHAR) = 'NaN' OR mob_e_mes_MRC IS NULL,0,mob_e_mes_MRC) AS mob_e_mes_MRC
