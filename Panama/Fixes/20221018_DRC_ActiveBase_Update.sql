--CREATE TABLE IF NOT EXISTS "lla_cco_int_stg"."cwp_mobile_sep18_NP_mes7_vf" AS
...
,MonthCleaning AS(
SELECT m.*
,CASE WHEN j.AccountNo IS NOT NULL and MobileMainMovement = '6.Null last day' THEN 1 ELSE 0 END AS DRC --CONDICION MODIFICADA 12/10/2022
